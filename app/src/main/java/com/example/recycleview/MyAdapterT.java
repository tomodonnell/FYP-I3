...
public class MyAdapterT extends RecyclerView.Adapter<MyAdapterT.ExampleViewHolder> {

    //Creating variable to contain list, allowing us to pass to adapter
    private ArrayList<Tipperary_Item> mTipperary_Item;
    ...
    public MyAdapterT(ArrayList<Tipperary_Item> tipperaryitem) {
        mTipperary_Item = tipperaryitem;
    }

    @NonNull
    @Override
    //Passing layout from xml file
    public MyAdapterT.ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.attraction_profile, parent, false);
        MyAdapterT.ExampleViewHolder evh = new ExampleViewHolder(v);
        return evh;
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.recycleview.MyAdapterT.ExampleViewHolder holder, int position) {

        //Passing values to our variables by setting equal to items from Province_Item.java
        Tipperary_Item currentItem = mTipperary_Item.get(position);
    ...
    public int getItemCount() {
        return mTipperary_Item.size();
    }

    //Creating filter list method
    public void filterList(ArrayList<Tipperary_Item> filteredList) {
        mTipperary_Item = filteredList;
