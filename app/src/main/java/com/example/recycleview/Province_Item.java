...
public class Province_Item {
    ...
    //Creating constructor for Province_Item, passing arguments into it and setting equal to variables
    public Province_Item(int imageResource, String text1, String text2) {
