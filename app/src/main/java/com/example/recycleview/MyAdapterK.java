...
public class MyAdapterK extends RecyclerView.Adapter<MyAdapterK.ExampleViewHolder> {

    //Creating variable to contain list, allowing us to pass to adapter
    private ArrayList<Kerry_Item> mKerry_Item;
    ...
    public MyAdapterK(ArrayList<Kerry_Item> kerryitem) {
        mKerry_Item = kerryitem;
    }

    @NonNull
    @Override
    //Passing layout from xml file
    public MyAdapterK.ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.attraction_profile, parent, false);
        MyAdapterK.ExampleViewHolder evh = new ExampleViewHolder(v);
        return evh;
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.recycleview.MyAdapterK.ExampleViewHolder holder, int position) {

        //Passing values to our variables by setting equal to items from Province_Item.java
        Kerry_Item currentItem = mKerry_Item.get(position);
    ...
    public int getItemCount() {
        return mKerry_Item.size();
    }

    //Creating filter list method
    public void filterList(ArrayList<Kerry_Item> filteredList) {
        mKerry_Item = filteredList;
